...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700;0,900;1,400&family=DM+Sans:wght@300;400;500;600&family=JetBrains+Mono:wght@400;500&display=swap" rel="stylesheet" />
    ...
    <link rel="stylesheet" href="components/writer/writer.css" />
        ...
        <div class="comm-loading">Loading communities...</div>
          ...
          <div class="view-panel writer-view" id="view-write">
            ...
            <div class="writer-meta">
              <select id="article-cat">
                <option>Select Category</option>
              </select>
              <input
                type="text"
                id="article-tags"
                placeholder="Tags: AI, machine learning…"
              />
              <input
                type="text"
                id="article-img"
            ...
            <div class="quality-analyzer">
              ...
              <div class="quality-scores">
                ...
                <div class="quality-score">
                  <div class="q-val" id="q-orig">—</div>
                  <div class="q-lbl">Originality</div>
                  <div class="score-bar">
                    <div
                      class="score-fill"
                      id="qb-orig"
                ...
                <div class="quality-score">
                  <div class="q-val" id="q-kw">—</div>
                  <div class="q-lbl">Keywords</div>
                  <div class="score-bar">
                    <div class="score-fill" id="qb-kw" style="width: 0%"></div>
                  </div>
                </div>
                <div class="quality-score">
                  ...
                  <div class="score-bar">
                    <div class="score-fill" id="qb-eng" style="width: 0%"></div>
                  </div>
                </div>
              </div>
              <div
                id="quality-feedback"
                style="margin-top: 11px; font-size: 13px; color: var(--text2)"
              ></div>
            </div>
...
<!-- ⚠️ Supprimer les doublons analytics.js et right-rail.js -->
