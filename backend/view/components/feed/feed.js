...
IBlog.Feed = (() => {
      ...
      <div class="article-reader">
        ...
        <div class="reader-body">
          ...
          <div class="reader-podcast">
            ...
            <div class="section-card" style="width:100%;display:flex;align-items:center;justify-content:space-between;gap:16px;padding:16px 18px;margin:0;">
              <div>
                <strong style="display:block;margin-bottom:4px;">Podcast mode is premium</strong>
                <small style="color:var(--text2);">Upgrade to listen hands-free with voice controls.</small>
              </div>
              <button class="btn btn-premium" onclick="showPremium()">Unlock</button>
            </div>`}
          </div>
  ...
  function postReaderComment(id) {
    ...
    if (article) {
      ...
      IBlogTracker?.log('comment_article', {
        entityType: 'article',
        entityId: id,
        title: article.title || '',
        category: article.cat || article.category || '',
