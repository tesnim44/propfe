  ...
  <div class="hero-slides" id="heroSlides">
    ...
    <div class="hslide active">
      ...
      <div class="slide-body">
        ...
        <a href="#" class="slide-cta" onclick="showSignup(); return false;">Read Article <svg viewBox="0 0 24 24"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></a>
      </div>
    </div>
